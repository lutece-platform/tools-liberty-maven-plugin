...
public class MultipleConcurrentLibertyModulesPlTest extends BaseMultiModuleTest {
   ...
   public void multipleLibertyModulesPlTest() throws Exception {
      // Start first project
      String mavenPluginCommand = "mvn fr.paris.lutece.tools:liberty-maven-plugin:"+System.getProperty("mavenPluginVersion")+":dev -pl ear1 -am -DdebugPort=7777";
      ...
      String mavenPluginCommand2 = "mvn fr.paris.lutece.tools:liberty-maven-plugin:"+System.getProperty("mavenPluginVersion")+":dev -pl ear2 -am -DdebugPort=7778";
