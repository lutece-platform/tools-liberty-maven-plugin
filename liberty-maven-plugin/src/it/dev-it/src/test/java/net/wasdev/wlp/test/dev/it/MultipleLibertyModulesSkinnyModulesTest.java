...
public class MultipleLibertyModulesSkinnyModulesTest extends BaseMultiModuleTest {
   ...
   public void multipleLibertyModulesPlTest() throws Exception {
      String mavenPluginCommand = "mvn fr.paris.lutece.tools:liberty-maven-plugin:"+System.getProperty("mavenPluginVersion")+":dev -pl ear-skinny-modules -am -DhotTests=true";
